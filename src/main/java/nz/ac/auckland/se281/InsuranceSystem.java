...
public class InsuranceSystem {
  ...
  /**
   * createNewProfile method creates a new profile with the given username and age. It filters out
   * the cases when a new profile cannot be created, and prints out the appropriate message.
   *
   * @param userName is the Username of the profile that should be created as the new instance of a
   *     profile
  ...
  /**
   * loadProfile method loads the profile of the given username. It filters out the cases when a
   * profile cannot be loaded: ie. there is no profile created under that Username yet * @param
   * userName is the Username of the profile that should be loaded
   */
  ...
  /**
   * unloadProfile method unloads the profile that is currently loaded. It filters out the cases
   * when a profile cannot be unloaded: ie. there is no profile loaded
   */
  ...
  /**
   * deleteProfile method deletes the profile of the given username. It filters out the cases when a
   * profile cannot be deleted: ie. there is no profile created under that Username yet, or that
  ...
  /**
   * createPolicy method creates a new policy of the given type and options. It filters out the
   * cases when a policy cannot be created: ie. there is no profile loaded, or that profile already
   * has a life policy
   *
