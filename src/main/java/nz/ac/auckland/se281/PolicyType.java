...
public abstract class PolicyType {
  ...
  /**
   * get the make and model of the policies. Specific for the car policy: It will be overriden for
   * car. For every other policy, return "Does not exist"
   *
  ...
  /**
   * get the address the policy of the policies. Specific for the home policy: It will be overriden
   * for home. For every other policy, return "Does not exist"
   *
   * @return "Does not exist"
   */
